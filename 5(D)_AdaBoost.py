# -*- coding: utf-8 -*-
"""
Created on Tue Jul 16 12:45:09 2024
...
#%% Initialize AdaBoost classifier with hyperparameters
...
y_train_pred = ada_model.predict(X_res)
...
print("Test Set ROC AUC Score:", roc_auc_score(y_test, ada_model.predict_proba(X_test)[:, 1]))
...
print("Training Set ROC AUC Score:", roc_auc_score(y_res, ada_model.predict_proba(X_res)[:, 1]))
