# -*- coding: utf-8 -*-
"""
Created on Fri Jul 12 11:42:49 2024
...
keras_clf = KerasClassifier(model=build_model, input_dim=X_res.shape[1], epochs=100, batch_size=32, 
...
y_test_pred = keras_clf.predict(X_test)
